...
class AdminItemController
{
    ...
    public function create()
    {
        ...
        $stmt = $this->db->prepare("
            INSERT INTO items (name, description, type, slot_type, two_handed, width, height, weight, icon, stat_ranges, max_stack, price, is_purchasable, effect_type, duration_type, duration_value, effect_value)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
