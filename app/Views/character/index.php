...
<div class="relative z-10 h-screen flex flex-col">
    ...
    <header class="flex justify-between items-center p-6">
        <div class="text-2xl font-bold text-violet-500 tracking-wider uppercase">DungeonXplorer</div>
        <div class="flex items-center gap-4">
            <span class="text-gray-300">Bienvenue, <span class="text-white font-semibold"><?= htmlspecialchars($_SESSION['username']) ?></span></span>
            <a href="/logout" class="px-4 py-2 border border-red-500/50 text-red-400 rounded hover:bg-red-500/10 transition">Déconnexion</a>
        </div>
    </header>
    ...
    <main class="flex-1 flex items-center justify-center px-4">
        <div class="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <!-- Character List (Left) -->
            <div class="lg:col-span-3 space-y-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
            ...
            <div class="lg:col-span-6 flex flex-col items-center justify-center relative h-[60vh]">
                <!-- Pedestal Effect -->
                <div class="absolute bottom-0 w-full h-1/4 bg-gradient-to-t from-violet-900/20 to-transparent rounded-full blur-3xl"></div>
                
                <!-- Character Model -->
                <div class="relative z-10 h-full w-full flex items-center justify-center pb-12">
                ...
                <div class="absolute bottom-0 text-center">
                    <h1 class="text-5xl font-bold text-white mb-2 text-shadow-lg"><?= htmlspecialchars($selectedCharacter['name']) ?></h1>
                    <p class="text-xl text-violet-400 font-medium tracking-wide">
            ...
            <!-- Stats / Actions (Right) -->
            <div class="lg:col-span-3 bg-gray-800/80 backdrop-blur p-6 rounded-xl border border-gray-700">
                ...
                <button class="w-full py-4 bg-violet-600 hover:bg-violet-700 text-white font-bold rounded-lg shadow-lg shadow-violet-600/30 transition transform hover:-translate-y-1 uppercase tracking-wider text-lg">
                    Jouer
                </button>
                
                <button class="w-full mt-3 py-2 border border-gray-600 text-gray-300 hover:bg-gray-700 rounded-lg transition text-sm">
                    Supprimer
                </button>
            </div>
