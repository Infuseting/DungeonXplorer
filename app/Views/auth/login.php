            ...
            <div class="absolute bottom-0 left-0 p-12 text-white">
                <blockquote class="mt-8">
                    <p class="text-xl font-medium text-violet-100 italic">
                        "Le portail s'ouvre devant vous. Oserez-vous franchir le seuil et affronter votre destin ?"
                    </p>
                    <footer class="mt-4">
                        <p class="text-base font-semibold text-violet-200">Le Gardien du Donjon</p>
                    </footer>
                </blockquote>
            </div>
        </div>
