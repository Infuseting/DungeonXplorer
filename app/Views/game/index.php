...
<div class="relative w-full h-screen bg-gray-900 overflow-hidden">
    ...
    <div class="absolute top-4 left-4 z-50">
        ...
        <button id="back-to-parent-map"
            class="hidden mb-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg shadow-lg border-2 border-gray-600 flex items-center gap-2 transition-all hover:scale-105 active:scale-95">
        ...
        <div class="relative">
            ...
            <div id="user-dropdown"
                class="hidden absolute top-14 left-0 w-72 bg-gray-800 border-2 border-gray-600 rounded-lg shadow-xl overflow-hidden">
                <button id="load-save-button"
    ...
    <div id="xp-bar-container"
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="flex items-center gap-1">
                ...
                <span id="user-level" class="text-violet-400 font-bold font-mono text-lg"><?= $currentLevel ?></span>
            </div>
    ...
    <div class="absolute right-4 md:right-8 z-40 flex flex-col gap-2 md:gap-4"
        ...
        <button id="quest-journal-toggle"
            class="w-12 h-12 md:w-16 md:h-16 bg-purple-600 hover:bg-purple-700 text-white rounded-full shadow-lg border-2 border-purple-400 flex items-center justify-center transition-transform hover:scale-110 active:scale-95">
        ...
        <button id="inventory-toggle"
            class="w-12 h-12 md:w-16 md:h-16 bg-violet-600 hover:bg-violet-700 text-white rounded-full shadow-lg border-2 border-violet-400 flex items-center justify-center transition-transform hover:scale-110 active:scale-95">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <!-- Skills Button -->
        <button id="skills-toggle"
            class="w-12 h-12 md:w-16 md:h-16 bg-amber-600 hover:bg-amber-700 text-white rounded-full shadow-lg border-2 border-amber-400 flex items-center justify-center transition-transform hover:scale-110 active:scale-95">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div id="point-panel"
        class="fixed top-0 right-0 h-full w-full md:w-96 bg-gray-800/95 backdrop-blur-md border-l border-gray-700 shadow-2xl transform translate-x-full transition-transform duration-300 z-[60]">
    ...
    <div id="shop-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80">
        <div
            ...
            <div class="flex-1 flex flex-col lg:flex-row gap-4 overflow-hidden min-h-0">
                ...
                <div class="flex-1 bg-gray-800 rounded p-2 flex flex-col border border-gray-700 min-h-0">
                    <h3
                        class="text-lg font-bold text-gray-300 mb-2 text-center border-b border-gray-700 pb-1 flex-shrink-0">
                        Marchand</h3>
                ...
                <div class="flex-1 bg-gray-800 rounded p-2 flex flex-col border border-gray-700 min-h-0">
                    <h3 class="text-lg font-bold text-gray-300 mb-2 text-center border-b border-gray-700 pb-1">Votre
                        Inventaire</h3>
                    <div id="shop-inventory-list"
                        class="flex-1 overflow-y-auto pr-1 flex flex-wrap content-start gap-2">
                        <!-- Items populated by JS -->
                    </div>
                </div>
            </div>
    ...
    <!-- Toast Container -->
    <div id="toast-container" class="fixed right-4 z-50 flex flex-col gap-2 pointer-events-none"
