...
<html lang="en">
    ...
    <body class="bg-gray-900 text-white min-h-screen">
            ...
            <main class="flex-grow p-4 pt-0 md:p-4 md:pt-0 backdrop-blur-sm rounded-lg m-2">
                ...
                <div class="flex flex-col md:flex-col justify-center items-center gap-8">
                    ...
                    <div class="w-full md:w-[55%] h-[500px] bg-gray-700 rounded-lg flex items-center justify-center drop-shadow-[0_0_5px_#a78bfa]">
                        ...
                        <div  class =" absolute bottom-7 w-64 h-64 overflow-hidden">
                             <img id="monster-overlay" src="/assets/images/combats/disparition.png" class="absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-1000" />
                        ...
                        <div class="w-full md:w-1/3 flex flex-col bg-gray-900/50 rounded-lg">
                            ...
                            <ul class="text-sm grid grid-cols-2 gap-2 mx-auto">
                                <li>
                                    <button id="btn-attack" onclick="sendAction('attack')"
                                        class="w-full px-4 py-2 bg-gray-700 text-red-400 rounded-lg border border-violet-500/50 hover:bg-gray-600 hover:text-white hover:scale-105 transition transform duration-200">
                                        Attack
                                    </button>
                                </li>
                                ...
                                <li>
                                    <button id="btn-defend" onclick="sendAction('defend')"
                                        class="w-full px-4 py-2 bg-gray-700 text-blue-400 rounded-lg border border-violet-500/50 hover:bg-gray-600 hover:text-white hover:scale-105 transition transform duration-200">
                                        Shield
                                    </button>
                                </li>
                                ...
                                <li>
                                    <button id="btn-heal" onclick="sendAction('usePotion')"
                                        class="w-full px-4 py-2 bg-gray-700 text-yellow-400 rounded-lg border border-violet-500/50 hover:bg-gray-600 hover:text-white hover:scale-105 transition transform duration-200">
                                        Heal
                                    </button>
                                </li>

                                <li>
                                    <button id="btn-run" onclick="sendAction('run')"
                                        class="w-full px-4 py-2 bg-gray-700 text-green-400 rounded-lg border border-violet-500/50 hover:bg-gray-600 hover:text-white hover:scale-105 transition transform duration-200">
                                        ...
                                    </button>
                                </li>
                            </ul>
                            ...
                            <div class="mt-4 text-center">
                                <button onclick="rollDice()" id="rollBtn"
                                    class="text-violet-400 p-2 rounded-lg border border-violet-500 hover:bg-gray-600 hover:text-white hover:scale-105 transition transform duration-200">Lancer le dés</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            const overlay = document.getElementById("monster-overlay");
            ...
            function playerWin() {
                ...
                // Étape 2 : attendre un peu puis le faire disparaître
                setTimeout(() => {
                overlay.classList.remove("opacity-100");
                overlay.classList.add("opacity-0");
                }, 1000); // durée visible avant disparition
