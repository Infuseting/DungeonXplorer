...
<div id="inventory-modal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="relative z-10 w-full h-full flex items-center justify-center p-4 lg:p-8 pointer-events-none">
        <div
            class="bg-gray-800/90 border border-gray-600 rounded-2xl shadow-2xl flex flex-col lg:flex-row gap-4 lg:gap-8 p-4 lg:p-8 max-w-6xl w-full h-[90vh] lg:h-auto pointer-events-auto transform transition-all scale-100 overflow-hidden relative">
            <!-- Close Button -->
            ...
            <div class="w-full lg:w-1/2 flex flex-col min-h-0">
                <h2
                    class="text-xl lg:text-2xl font-bold text-white mb-4 lg:mb-6 border-b border-gray-600 pb-2 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 lg:h-6 lg:w-6 text-violet-400" fill="none"
                ...
                <div
                    class="flex-1 relative flex items-center justify-center bg-gray-900/50 rounded-xl border border-gray-700 p-2 lg:p-4 overflow-y-auto min-h-0">
                    <!-- Silhouette / Paper Doll -->
                    <div class="relative w-[240px] h-[350px] lg:w-[400px] lg:h-[600px] flex-shrink-0">
                        <!-- Head -->
                        <div class="absolute top-2 lg:top-4 left-1/2 transform -translate-x-1/2 w-12 h-12 lg:w-16 lg:h-16 slot rounded-lg"
                            data-slot="head">
                            <span class="slot-label">Tête</span>
                            <?php if (isset($inventory['equipped']['head'])):
                                echo renderEquippedItem($inventory['equipped']['head']); endif; ?>
                        </div>

                        <!-- Shoulders -->
                        <div class="absolute top-10 lg:top-16 left-4 lg:left-8 w-12 h-12 lg:w-16 lg:h-16 slot rounded-lg"
                            data-slot="shoulders">
                            <span class="slot-label">Épaules</span>
                            <?php if (isset($inventory['equipped']['shoulders'])):
                                echo renderEquippedItem($inventory['equipped']['shoulders']); endif; ?>
                        </div>

                        <!-- Amulet -->
                        <div class="absolute top-10 lg:top-16 right-4 lg:right-8 transform w-12 h-12 lg:w-16 lg:h-16 slot rounded-lg"
                            data-slot="amulet">
                            <span class="slot-label">Amulette</span>
                            <?php if (isset($inventory['equipped']['amulet'])):
                                echo renderEquippedItem($inventory['equipped']['amulet']); endif; ?>
                        </div>

                        <!-- Chest -->
                        <div class="absolute top-20 lg:top-36 left-1/2 transform -translate-x-1/2 w-16 h-20 lg:w-20 lg:h-24 slot rounded-lg"
                            data-slot="chest">
                            <span class="slot-label">Torse</span>
                            <?php if (isset($inventory['equipped']['chest'])):
                                echo renderEquippedItem($inventory['equipped']['chest']); endif; ?>
                        </div>

                        <!-- Gloves -->
                        <div class="absolute top-24 lg:top-40 left-4 lg:left-8 w-12 h-24 lg:w-16 lg:h-32 slot rounded-lg"
                            data-slot="gloves">
                            <span class="slot-label">Gants</span>
                            <?php if (isset($inventory['equipped']['gloves'])):
                                echo renderEquippedItem($inventory['equipped']['gloves']); endif; ?>
                        </div>

                        <!-- Bracers -->
                        <div class="absolute top-24 lg:top-40 right-4 lg:right-8 w-12 h-24 lg:w-16 lg:h-32 slot rounded-lg"
                            data-slot="bracers">
                            <span class="slot-label">Bracelets</span>
                            <?php if (isset($inventory['equipped']['bracers'])):
                                echo renderEquippedItem($inventory['equipped']['bracers']); endif; ?>
                        </div>

                        <!-- Belt -->
                        <div class="absolute top-[165px] lg:top-[260px] left-1/2 transform -translate-x-1/2 w-16 h-8 lg:w-20 lg:h-10 slot rounded-lg"
                            data-slot="belt">
                            <span class="slot-label">Ceinture</span>
                            <?php if (isset($inventory['equipped']['belt'])):
                                echo renderEquippedItem($inventory['equipped']['belt']); endif; ?>
                        </div>

                        <!-- Legs -->
                        <div class="absolute top-[200px] lg:top-[310px] left-1/2 w-16 h-20 lg:w-20 transform -translate-x-1/2 lg:h-24 slot rounded-lg"
                            data-slot="legs">
                            <span class="slot-label">Jambes</span>
                            <?php if (isset($inventory['equipped']['legs'])):
                                echo renderEquippedItem($inventory['equipped']['legs']); endif; ?>
                        </div>

                        <!-- Boots -->
                        <div class="absolute top-[290px] lg:top-[420px] left-1/2 w-16 h-12 lg:w-20 transform -translate-x-1/2 lg:h-16 slot rounded-lg"
                            data-slot="boots">
                            <span class="slot-label">Bottes</span>
                            <?php if (isset($inventory['equipped']['boots'])):
                                echo renderEquippedItem($inventory['equipped']['boots']); endif; ?>
                        </div>

                        <!-- Rings -->
                        <div class="absolute top-[200px] lg:top-[310px] left-6 lg:left-8 w-8 h-8 lg:w-10 lg:h-10 slot rounded-full"
                            data-slot="ring_1">
                            <span class="slot-label">Ring1</span>
                            <?php if (isset($inventory['equipped']['ring_1'])):
                                echo renderEquippedItem($inventory['equipped']['ring_1']); endif; ?>
                        </div>
                        <div class="absolute top-[200px] lg:top-[310px] right-6 lg:right-8 w-8 h-8 lg:w-10 lg:h-10 slot rounded-full"
                            data-slot="ring_2">
                            <span class="slot-label">Ring2</span>
                            <?php if (isset($inventory['equipped']['ring_2'])):
                                echo renderEquippedItem($inventory['equipped']['ring_2']); endif; ?>
                        </div>

                        <!-- Main Hand -->
                        <div class="absolute top-[240px] lg:top-[360px] left-4 lg:left-8 w-12 h-24 lg:w-16 lg:h-32 slot rounded-lg"
                            data-slot="main_hand">
                        ...
                        <!-- Off Hand -->
                        <div class="absolute top-[240px] lg:top-[360px] right-4 lg:right-8 w-12 h-24 lg:w-16 lg:h-32 slot rounded-lg"
                            data-slot="off_hand">
                        ...
                        <div class="absolute bottom-4 right-[-30px] w-10 h-10 lg:w-12 lg:h-12 slot rounded-lg border-yellow-500/50"
                            data-slot="backpack">
                            <span class="slot-label">Sac</span>
                            <?php if (isset($inventory['equipped']['backpack'])):
                                echo renderEquippedItem($inventory['equipped']['backpack']); endif; ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/2 flex flex-col min-h-0">
                <div class="flex items-center justify-between mb-3 lg:mb-4">
                    <h2 class="text-xl lg:text-2xl font-bold text-white flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 lg:h-6 lg:w-6 text-violet-400"
                    ...
                    <button id="inventory-close-btn"
                        class="lg:hidden text-gray-400 hover:text-white text-2xl">&times;</button>
                </div>
                ...
                <div id="inventory-grid"
                    class="flex-1 flex flex-col bg-gray-900/50 p-2 lg:p-4 rounded-xl border border-gray-700 overflow-hidden min-h-0">
                    <div class="flex flex-col gap-2 mb-2 lg:mb-3">
                        <div class="flex justify-between items-center">
                            <h3 class="text-xs lg:text-sm font-medium text-gray-400 uppercase tracking-wider">Contenu
                            </h3>

                            <!-- Sort Controls -->
                            <select id="sort-select"
                                class="bg-gray-800 text-xs text-white border border-gray-600 rounded px-2 py-1 focus:outline-none focus:border-violet-500">
                        ...
                        <div class="flex gap-2 text-xs overflow-x-auto pb-1" id="filter-buttons">
                            <button
                                class="filter-btn px-3 py-1 bg-violet-600 text-white rounded-full transition-colors whitespace-nowrap active"
                                data-filter="all">Tout</button>
                            <button
                                class="filter-btn px-3 py-1 bg-gray-700 text-gray-300 hover:text-white rounded-full transition-colors whitespace-nowrap"
                                data-filter="equipment">Équipements</button>
                            <button
                                class="filter-btn px-3 py-1 bg-gray-700 text-gray-300 hover:text-white rounded-full transition-colors whitespace-nowrap"
                                data-filter="consumable">Conso</button>
                            <button
                                class="filter-btn px-3 py-1 bg-gray-700 text-gray-300 hover:text-white rounded-full transition-colors whitespace-nowrap"
                                data-filter="resource">Ressources</button>
                        </div>
                    </div>
                            ...
                            <?php if (isset($inventory['inventory']) && !empty($inventory['inventory'])): ?>
                                <?php foreach ($inventory['inventory'] as $item):
                                    ...
                                    <div class="inventory-item-slot w-16 h-16 bg-gray-800/80 border-2 border-gray-600 relative flex items-center justify-center transition-all duration-200 hover:border-gray-500 hover:bg-gray-700/90 [&.drag-over]:border-violet-500 [&.drag-over]:bg-violet-500/20 rounded-lg <?= $enchantedClass ?>"
                                        data-location="inventory" data-inventory-id="<?= $item['id'] ?>"
                                        data-price="<?= $item['price'] ?? 0 ?>" data-weight="<?= $item['weight'] ?? 0 ?>"
                                        data-name="<?= htmlspecialchars($item['name']) ?>"
                                        data-type="<?= htmlspecialchars($item['type']) ?>"
                                        data-slot-type="<?= htmlspecialchars($item['item_slot_type']) ?>"
                                        data-description="<?= htmlspecialchars($item['description']) ?>"
                                        data-stats='<?= $statsJson ?>' data-enchantments='<?= $enchantmentsJson ?>'
                                        data-id="<?= $item['id'] ?>">
                                        <img src="/<?= $item['icon'] ?>"
                                        ...
                                        <?php if (isset($item['quantity']) && $item['quantity'] > 1): ?>
                                            <span
                                                class="absolute bottom-0 right-1 text-xs font-bold text-white drop-shadow-md z-[3]"><?= $item['quantity'] ?></span>
                                        <?php endif; ?>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', () => {
                        ...
                        // Filter and sort functionality is now handled by inventory.js
                        // to ensure it works after AJAX refresh
                    });
                </script>
            </div>
        </div>
...
<!-- Tooltip Container -->
<div id="item-tooltip"
    class="fixed hidden bg-gray-900 border border-gray-600 p-3 rounded shadow-xl max-w-xs text-sm text-gray-300 z-[9999]">
...
<div id="item-context-menu"
    class="fixed hidden z-50 bg-gray-800 border border-gray-600 rounded-lg shadow-xl w-48 py-1 overflow-hidden">
    <button id="ctx-equip"
    ...
    <button id="ctx-unequip"
        class="w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors flex items-center gap-2 hidden">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
        </svg>
    ...
    <button id="ctx-drop"
        class="w-full text-left px-4 py-2 text-sm text-red-400 hover:bg-red-900/30 hover:text-red-300 transition-colors flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
