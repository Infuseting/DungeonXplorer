...
<div id="submap-modal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="relative w-full h-full flex flex-col">
        ...
        <div id="submap-point-panel"
            class="absolute top-0 right-0 h-full w-full md:w-96 bg-gray-900 border-l border-gray-700 shadow-2xl transform translate-x-full transition-transform duration-300 overflow-y-auto">
            <div class="p-6">
