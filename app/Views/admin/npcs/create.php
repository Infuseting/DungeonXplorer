        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="col-span-2 hidden bg-gray-900 p-6 rounded-xl border border-gray-700" id="merchant-fields">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="col-span-2">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="inventory_type" value="seed" checked
                                    onchange="toggleInventoryType()">
                                <span>Génération Aléatoire (SEED)</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="inventory_type" value="manual"
                                    onchange="toggleInventoryType()">
                    ...
                    <div id="inventory-seed-section" class="contents">
                        <div class="form-group">
                    ...
                    <div id="inventory-manual-section" class="col-span-2 hidden">
                            ...
                            <?php if (!empty($items)): ?>
                                <?php foreach ($items as $item): ?>
                                    <label class="flex items-center gap-2 p-2 hover:bg-gray-700 rounded cursor-pointer">
                                        ...
                                        <div class="text-sm">
                                            <span class="text-gray-200 block"><?= htmlspecialchars($item['name']) ?></span>
...
<script>
    ...
    function updateMerchantFields() {
        ...
        // Trigger inventory type check to set required correctly
        toggleInventoryType();
    }
