        ...
        <div class="form-group">
            ...
            <div class="flex gap-2">
                <select id="reward-item-select"
                    class="flex-grow p-2 bg-slate-950 border border-slate-700 rounded-lg text-slate-200">
                ...
                <input type="number" id="reward-item-qty" value="1" min="1"
                    class="w-24 p-2 bg-slate-950 border border-slate-700 rounded-lg text-slate-200" placeholder="Qté">
