        ...
        <div class="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="map_x" step="0.000001" class="form-input w-full" value="<?= $house['map_x'] ?? '' ?>">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-2">Coordonnée Y (latitude)</label>
                    <input type="number" name="map_y" step="0.000001" class="form-input w-full" value="<?= $house['map_y'] ?? '' ?>">
                </div>
            </div>
